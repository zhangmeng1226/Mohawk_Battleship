...
namespace MBC.Core.Matches
{
    ...
    public class Match
    {
        ...
        public void Begin(Configuration newConfig, params Player newPlayers)
        {
            Begin(newConfig, newPlayers);
        }

        public void Begin(Configuration newConfig, IEnumerable<Player> newPlayers)
        {
